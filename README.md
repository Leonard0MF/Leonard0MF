...
> Built under **Elyra Studio** — focused on performance, modern UI/UX, and real business results.

| Project | Description | Stack | Live |
|--------|-------------|-------|------|
| 🌐 **Elyra** | Landing page ecosystem for small businesses | Next.js · React · TypeScript | [↗](https://elyras.vercel.app/) |
| 💆 **Espaço Lazuli** | High-conversion platform focused on UI/UX and client onboarding | React · Tailwind | [↗](https://espaco-lazuli.vercel.app/) |
| 🦶 **Lita Podóloga** | Business website with automated lead generation | React · Tailwind | [↗](https://lita-podologa.vercel.app/) |

---

## 🔬 Security Labs

- 🛡️ **[Mini Honeypot](https://github.com/Leonard0MF/MINY-HONEYPOT)** `Python` — Simulates and logs unauthorized network intrusion attempts in a controlled environment.
- 🔍 **[OSINT Automation Tool](https://github.com/Leonard0MF/osint-base)** `Python` — Automates public data gathering and intelligence analysis workflows.
...
- Deepening backend security and pen-testing skills
- Scaling Elyra Studio to more real-world clients
